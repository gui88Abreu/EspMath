 ...
 */
esp_err_t dsps_add_s8_esp(const int8_t *x1,\
                          const int8_t *x2,\
                          int8_t *y,\
                          int len,\
                          int step_x1 = 1,\
 ...
 *      - One of the error codes from DSP library
 */
esp_err_t dsps_add_s16_esp(const int16_t *x1,\
                          const int16_t *x2,\
                          int16_t *y,\
                          int len,\
                          int step_x1 = 1,\
 ...
 *      - One of the error codes from DSP library
 */
esp_err_t dsps_add_s32_esp(const int32_t *x1,\
                          const int32_t *x2,\
                          int32_t *y,\
                          int len,\
                          int step_x1 = 1,\
 ...
 *      - One of the error codes from DSP library
 */
esp_err_t dsps_add_f32_esp(const float *x1,\
                          const float *x2,\
                          float *y,\
                          int len,\
                          int step_x1 = 1,\
