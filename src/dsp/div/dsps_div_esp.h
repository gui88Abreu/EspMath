#ifndef _custom_dsps_div_H_
#define _custom_dsps_div_H_
#include "dsp_err.h"
 ...
 */
esp_err_t dsps_div_s8_esp(const int8_t *x1,\
                          const int8_t *x2,\
                          int8_t *y,\
                          int len,\
                          int step_x1 = 1,\
 ...
 *      - One of the error codes from DSP library
 */
esp_err_t dsps_div_s16_esp(const int16_t *x1,\
                          const int16_t *x2,\
                          int16_t *y,\
                          int len,\
                          int step_x1 = 1,\
 ...
 *      - One of the error codes from DSP library
 */
esp_err_t dsps_div_s32_esp(const int32_t *x1,\
                           const int32_t *x2,\
                           int32_t *y,\
                           int len,\
                           int step_x1 = 1,\
 ...
 *      - One of the error codes from DSP library
 */
esp_err_t dsps_div_f32_esp(const float *x1,\
                           const float *x2,\
                           float *y,\
                           int len,\
                           int step_x1 = 1,\
